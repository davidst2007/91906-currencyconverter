...
# main routine
settings_validator(s.settings.items(), (settings_read(s.json_name)), s.default_dict, s.json_name)

print("What do you want to set style to?")
settings_modify(s.json_name, "style", input())

print("What do you want to set help_button_hide to?")
settings_modify(s.json_name, "help_button_hide", input())